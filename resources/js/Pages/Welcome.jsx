...
export default function Welcome({ auth, categories = [], properties = [], filters = {} }) {
    ...
    return (
        <div className="bg-white min-h-screen font-['Inter',sans-serif] text-gray-800 antialiased">
                        ...
                        <div className="flex items-center gap-2 sm:gap-4">
                            {auth.user ? (
                                <div className="flex items-center gap-2 sm:gap-4">
                                    ...
                                    <Link 
                                        href={route('dashboard')} 
                                        className="md:hidden w-8 h-8 rounded-full bg-gradient-to-br from-[#3D74B6] to-[#2b5382] flex items-center justify-center text-white text-sm font-bold"
                                    >
                                        {auth.user.name.charAt(0)}
                                    </Link>
                                </div>
                                ...
                                <>
                                    <button 
                                        ...
                                        className="lg:hidden p-1.5 text-gray-600 hover:text-[#FA5C5C]"
                                    >
                                        <Menu size={20} className="sm:w-6 sm:h-6" />
                                    </button>
                                    <div className="hidden lg:flex items-center gap-3">
                                        <Link href={route('login')} className="text-sm font-medium text-gray-600 hover:text-[#3D74B6] transition-colors">
                                            Sign In
                                        </Link>
                                        <Link 
                                            href={route('register')} 
                            ...
                            <div className="flex flex-col space-y-3">
                                {['Buy', 'Rent', 'Commercial', 'Market Insights', 'Agents', 'About'].map((item) => (
                                    <Link 
                                        key={item} 
                                        href="#" 
                                        className="text-sm font-medium text-gray-600 hover:text-[#FA5C5C] py-2"
                                ...
                                <div className="pt-3 border-t border-gray-100 space-y-3">
                                    <Link 
                                        href={route('login')} 
                                        className="block text-sm font-medium text-gray-600 hover:text-[#3D74B6] py-2"
                                        onClick={() => setMobileMenuOpen(false)}
                                    >
                                        Sign In
                                    </Link>
                                    <Link 
                                        href={route('register')} 
                                        className="block bg-gradient-to-r from-[#3D74B6] to-[#2b5382] text-white px-6 py-2.5 rounded-lg text-sm font-semibold hover:from-[#2b5382] hover:to-[#3D74B6] transition-all"
                                        onClick={() => setMobileMenuOpen(false)}
                                    >
                                        Get Started
                                    </Link>
            ...
            <section className="relative pt-24 sm:pt-28 md:pt-32 pb-12 sm:pb-16 md:pb-20 bg-gradient-to-b from-white to-gray-50 overflow-hidden">
                {/* Background Elements */}
                <div className="absolute top-10 right-4 sm:right-10 w-64 h-64 sm:w-96 sm:h-96 bg-[#FA5C5C]/5 rounded-full blur-3xl"></div>
                <div className="absolute bottom-10 left-4 sm:left-10 w-56 h-56 sm:w-80 sm:h-80 bg-[#FA5C5C]/3 rounded-full blur-3xl"></div>
                        ...
                        <div className="space-y-6 sm:space-y-8">
                            <div className="space-y-4 sm:space-y-6">
                                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                                    Find Your <span className="bg-gradient-to-r from-[#FA5C5C] to-red-800 bg-clip-text text-transparent">Perfect</span> Property
                                </h1>
                            ...
                            <form onSubmit={handleSearch} className="space-y-3 sm:space-y-4" ref={searchRef}>
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3 p-1.5 sm:p-2 bg-white rounded-xl sm:rounded-2xl border border-gray-200 shadow-lg">
                                            ...
                                            <div className="absolute top-full left-0 right-0 mt-1 sm:mt-2 bg-white rounded-lg sm:rounded-xl shadow-2xl border border-gray-100 overflow-hidden z-50">
                                                {locations.map((loc, idx) => (
                                                    <button 
                                                        ...
                                                        className="w-full text-left px-3 py-2 sm:px-4 sm:py-3 hover:bg-red-50 transition-colors flex items-center gap-2 sm:gap-3 border-b border-gray-50 last:border-none"
                                                    >
                                                        <MapPin size={14} className="sm:w-4 sm:h-4 text-[#3D74B6]" />
                                    ...
                                    <button 
                                        type="submit"
                                        className="bg-gradient-to-r from-[#3D74B6] to-[#2b5382] text-white h-full px-4 py-2.5 sm:px-6 sm:py-3.5 rounded-lg font-bold text-xs sm:text-sm hover:translate-y-[-1px] transition-all shadow-lg shadow-blue-100 flex items-center justify-center gap-2 sm:gap-3 group col-span-1 sm:col-span-2 lg:col-span-1"
                                    >
                                ...
                                {stats.map((stat, index) => (
                                    <div key={index} className="flex items-center gap-2 sm:gap-3">
                                        <div className="w-8 h-8 sm:w-10 sm:h-10 bg-blue-50 rounded-lg flex items-center justify-center">
                                            <stat.icon size={14} className="sm:w-4 sm:h-4 text-[#3D74B6]" />
                                        </div>
                                        <div>
                                ...
                                <div className="space-y-3 sm:space-y-4 lg:space-y-6 pt-4 sm:pt-6 lg:pt-10">
                                    <div className="relative overflow-hidden rounded-lg sm:rounded-xl lg:rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-500">
                                        ...
                                        <div className="absolute bottom-2 left-2 sm:bottom-3 sm:left-3 lg:bottom-4 lg:left-4 bg-white/90 backdrop-blur-sm px-2 py-1 sm:px-3 sm:py-1.5 lg:px-3 lg:py-2 rounded-lg">
                                            ...
                                            <p className="text-[10px] sm:text-xs text-gray-600">Premium Picks</p>
                                        </div>
                                    </div>
                            ...
                            <div className="absolute -bottom-4 -left-4 sm:-bottom-6 sm:-left-6 bg-white rounded-lg sm:rounded-xl shadow-lg p-3 sm:p-4 lg:p-6 max-w-[180px] sm:max-w-xs">
                                <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-4">
                                    <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg flex items-center justify-center">
                                        <Award size={16} className="sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-[#3D74B6]" />
                                    </div>
                                    <div>
                                        <p className="text-xs sm:text-sm font-bold text-gray-900">Award Winning</p>
                                        <p className="text-[10px] sm:text-xs text-gray-500">Real Estate 2026</p>
                                    </div>
                                </div>
                                <p className="text-[10px] sm:text-xs text-gray-600">
                                    Recognized for excellence in property management and client satisfaction.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 sm:pt-8">
                    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg sm:rounded-xl lg:rounded-2xl p-4 sm:p-6">
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
                            ...
                            <div className="flex items-center gap-2 sm:gap-4">
                                <button className="flex items-center gap-1.5 sm:gap-2 px-3 py-1.5 sm:px-4 sm:py-2 bg-white border border-gray-200 rounded-lg text-xs sm:text-sm font-medium text-gray-700 hover:border-[#3D74B6] hover:text-[#3D74B6] transition-colors">
                                    <Filter size={14} className="sm:w-4 sm:h-4" />
                                    Filter
                                </button>
                                <Link 
                                    href={route('welcome')} 
                                    className="px-3 py-1.5 sm:px-4 sm:py-2 bg-white border border-gray-200 rounded-lg text-xs sm:text-sm font-medium text-gray-700 hover:border-[#3D74B6] hover:text-[#3D74B6] transition-colors flex items-center gap-1.5 sm:gap-2"
                                >
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center py-12 sm:py-16 lg:py-20">
                            <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl sm:rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6">
                                <Search size={24} className="sm:w-8 sm:h-8 text-[#3D74B6]" />
                            </div>
                            ...
                            <Link 
                                href={route('welcome')} 
                                className="inline-flex items-center gap-1.5 sm:gap-2 px-4 py-2.5 sm:px-6 sm:py-3 bg-gradient-to-r from-[#3D74B6] to-blue-600 text-white rounded-lg font-semibold text-sm sm:text-base hover:from-blue-700 hover:to-blue-800 transition-all"
                            >
                    ...
                    Object.keys(groupedByDivision).map((division) => (
                        <div key={division} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8 sm:mb-12 lg:mb-16">
                            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-3 sm:gap-4 mb-6 sm:mb-8">
                                <div className="flex-1">
                                    <div className="flex items-center gap-2 sm:gap-3 mb-1 sm:mb-2">
                                        <div className="w-1.5 h-6 sm:w-2 sm:h-8 bg-gradient-to-b from-[#3D74B6] to-blue-800 rounded-full"></div>
                                ...
                                <Link 
                                    ...
                                    className="flex items-center gap-1.5 text-[#3D74B6] font-semibold text-sm sm:text-base hover:gap-2 transition-all"
                                >
                                    View All
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                {groupedByDivision[division].slice(0, 3).map((property) => (
            ...
            <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-r from-[#3D74B6] to-blue-800">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                            <Link 
                                ...
                                className="bg-white text-[#3D74B6] px-6 py-3 sm:px-8 sm:py-4 rounded-lg font-bold text-sm sm:text-base hover:bg-gray-50 transition-all shadow-lg"
                            >
                                Start Your Search
                            </Link>
                            <Link 
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-12 mb-8 sm:mb-12">
                        <div className="lg:col-span-2 space-y-4 sm:space-y-6">
                            <div className="flex items-center gap-2 sm:gap-3">
                                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-[#3D74B6] to-blue-700 rounded-lg sm:rounded-xl flex items-center justify-center">
                                    <Building size={20} className="sm:w-6 sm:h-6" />
                                </div>
                                <div>
                                    <span className="text-xl sm:text-2xl font-bold tracking-tight">ALMAMON</span>
                                    <p className="text-xs sm:text-sm text-gray-400">Real Estate Excellence</p>
                                </div>
                            </div>
                        ...
                        <div>
                            <h6 className="text-xs sm:text-sm font-semibold mb-3 sm:mb-6 text-white">Quick Links</h6>
                        ...
                        <div>
                            <h6 className="text-xs sm:text-sm font-semibold mb-3 sm:mb-6 text-white">Company</h6>
                            <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm">
